...
3. Place the CSV's generated in a folder name 'Tables' and place this folder in the D drive ( this is because we were unable to have
	 a relative location in the MySQL script. )
	Path - D:/Tables/<contains CSV's>
